...
export async function PUT(
	...
	const creator = new ProductCreator(new PostgresWithViewProductRepository(postgresConnection));
...
export async function GET(
	...
	const finder = new ProductFinder(new PostgresWithViewProductRepository(postgresConnection));

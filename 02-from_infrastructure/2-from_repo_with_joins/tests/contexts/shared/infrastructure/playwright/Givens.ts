...
import { PostgresWithJoinsProductRepository } from "../../../../../src/contexts/shop/products/infrastructure/PostgresWithJoinsProductRepository";
...
const productRepository = new PostgresWithJoinsProductRepository(connection);
